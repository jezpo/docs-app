...
class DocumentosController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $documentos = Documento::select('id', 'cite', 'descripcion', 'estado', 'id_tipo_documento', 'id_programa', 'id_origen_tipo')->find($id);
    ...
    */
    ...
    try {
        ...
        $data = [
            ...
            'hash' => hash('md5', $request->cite . $request->descripcion),
            'id_tipo_documento' => $request->id_tipo_documento,
            'documento' => $fileData,
            'id_programa' => $request->id_programa,
            'id_origen_tipo' => $request->origen_tipos_id,
        ];

        Documento::updateData($id, $data);
